...
export const RPC_REQUIRED_SCOPES = {
  ...
  [ORCHESTRATION_WS_METHODS.listExternalConversations]: AuthOrchestrationOperateScope,
  [ORCHESTRATION_WS_METHODS.importExternalConversation]: AuthOrchestrationOperateScope,
  ...
  [WS_METHODS.projectsTransfer]: AuthOrchestrationOperateScope,

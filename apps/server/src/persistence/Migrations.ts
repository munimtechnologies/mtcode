...
import Migration0056 from "./Migrations/055_ProjectionThreadsAutoSettleDisabledAt.ts";
// Upstream 053 (PR #9124); file renumbered to 056 and registered as the next free fork id.
import Migration0057 from "./Migrations/056_ProjectionThreadsLastVisitedAt.ts";
...
const migrationEntries = [
  ...
  [57, "ProjectionThreadsLastVisitedAt", Migration0057],
] as const;

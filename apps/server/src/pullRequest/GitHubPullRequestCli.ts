...
export const make = Effect.gen(function* () {
  ...
  // The diff revision (base and head oids) rides on the core GraphQL read as `baseRefOid` and
  // `headRefOid`, so the detail no longer costs a separate REST request for it.

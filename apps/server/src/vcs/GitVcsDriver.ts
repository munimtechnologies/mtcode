    ...
    captureCheckpoint: Effect.fn("GitVcsDriver.checkpoints.captureCheckpoint")(function* (input) {
      ...
      yield* Effect.gen(function* () {
        ...
        if (headExists) {
          const reusedIndex = yield* Effect.gen(function* () {
            ...
            yield* execute({
              operation,
              cwd: input.cwd,
              args: [...TEMP_INDEX_CONFIG_ARGS, ...indexConfig, "read-tree", "--reset", "HEAD"],
              env: commitEnv,
            });
          ...
          if (!reusedIndex) {
            ...
            yield* execute({
              ...
              args: sparseCheckout
                ...
                : [...TEMP_INDEX_CONFIG_ARGS, "read-tree", "HEAD"],
              env: commitEnv,
            });
          }
        }
        ...
        const writeTreeResult = yield* execute({
          operation,
          cwd: input.cwd,
          args: [...TEMP_INDEX_CONFIG_ARGS, ...indexConfig, ...durableWrite, "write-tree"],
          env: commitEnv,
        });

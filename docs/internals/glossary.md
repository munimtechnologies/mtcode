...
| Worktree       | A separate Git checkout a thread can use instead of the project's main checkout. On creation the driver copies untracked files matching a repo-root `.worktreeinclude` into it. |

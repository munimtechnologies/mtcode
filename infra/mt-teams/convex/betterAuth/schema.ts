/**
 * Local-install schema for the Better Auth component: the base tables shipped
 * with @convex-dev/better-auth 0.12.3 plus the organization plugin's tables
 * (organization/member/invitation) and the session.activeOrganizationId field.
 */
...
export const tables = {
  ...
  // Organization plugin tables (organizations = MT Teams).

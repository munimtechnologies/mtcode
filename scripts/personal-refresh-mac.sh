...
# Pulls sheehanmunim/t3code personal, builds arm64 DMG, installs, removes Nightly.
set -euo pipefail
...
echo "Installed: $(defaults read "/Applications/T3 Code (Alpha).app/Contents/Info" CFBundleShortVersionString)"
